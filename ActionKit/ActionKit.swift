...
class ActionKitSingleton {
    var controlAndEventsDict: Dictionary<UIControl, Dictionary<ActionKitUIControlEventsStruct, (sender:UIControl) -> Void>> = Dictionary()
...
//
    ...
    func addAction(control: UIControl, controlEvent: UIControlEvents, closure: (sender:UIControl) -> Void)
    {
        let controlStruct = ActionKitUIControlEventsStruct(value: controlEvent)
        if var innerDict = controlAndEventsDict[control] {
            ...
            var newDict = Dictionary<ActionKitUIControlEventsStruct, (sender:UIControl) -> Void>()
    ...
    func runClosureTouchDown(control: UIControl)
    {
        ...
        if let innerDict = controlAndEventsDict[control] {
            if let possibleClosure = innerDict[controlStruct] {
                possibleClosure(sender: control)
            }
        }
    }
